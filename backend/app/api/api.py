...
from app.api.endpoints import auth, products, sales, dashboard, cash, suppliers, purchases, einvoice, superadmin
...
api_router.include_router(einvoice.router, prefix="/einvoice", tags=["Facturación Electrónica"])
